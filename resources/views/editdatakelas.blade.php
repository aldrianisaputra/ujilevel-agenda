...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Input Data Guru</h4>
                                ...
                                <form action="/updatedatakelas/{{$data->id}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" value="{{$data->walikelas}}" name="walikelas" >
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="nama" class="col-sm-2 col-form-label">Nama Kelas</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" value="{{$data->namakelas}}" name="namakelas">
                                            </div>
                                        </div>
                                        <div class="mt-4">
