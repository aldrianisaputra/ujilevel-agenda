                                    ...
                                    <form action="/insertdataagenda" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="siswaabsen" placeholder="siswa yang tidak hadir">
                                                </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="linkpembelajaran" placeholder="Link diisi apabila metode online">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
